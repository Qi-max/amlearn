...
class TestMro(AmLearnTest):
    ...
    def test_volume_area_interstice_mro(self):
        mro = MRO(output_file_prefix='volume_area_interstice_mro')
    ...
    def test_cluster_packing_mro(self):
        mro = MRO(output_file_prefix='cluster_packing_efficiency_mro')
    ...
    def test_all_interstice_and_packing_mro(self):
        ...
        mro = MRO(output_file_prefix='all_insterstice_and_packing_mro')
