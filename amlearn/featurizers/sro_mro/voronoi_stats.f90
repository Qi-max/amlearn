...
!f2py   intent(in, out) :: voronoi_index_list
    ...
    SUBROUTINE character_motif(motif_one_hot, voronoi_index_list, n_atoms,
                               target_voro_idx, frank-kasper, target_num,
                               )
    ! [[0,0,12,0,0], [0,0,12,4,0]]
    ! target_num should incluede frank-kasper
        integer :: n_atoms
        integer, dimension(n_atoms, :) :: voronoi_index_list
        integer, dimension(:, :) target_voro_idx
        integer:: frank-kasper
        integer, dimension(:, :) :: voronoi_index_list
        integer, dimension(size(target_voro_idx, 1) + frank-kasper) :: motif_one_hot
